...
func (app *Application) initAuthboss() {
	...
	ab.Config.Storage.Server = models.NewUserStorer(app.DB)

	userSessionStore := models.NewUserSessionStore()
...
func (app *Application) Run() {
	...
	server := &http.Server{
		...
		ErrorLog:     log.New(&usecases.FwdToZapWriter{Logger: app.Log}, "", 0),
